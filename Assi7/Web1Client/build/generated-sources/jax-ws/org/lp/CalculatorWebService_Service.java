 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://lp.org/", wsdlLocation = "http://localhost:8080/Web1/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://lp.org/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Web1/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://lp.org/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lp.org/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
